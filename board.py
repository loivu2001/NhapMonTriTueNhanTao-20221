...
class Board:
    ...
    def __init__(self, n, board=None, random_shifts=1000, board_prints=True):
        ...
        n_blocks = (n,n)
        my_image = cv2.imread('D:\Phong\Python\AI\BTL_AI\Image\Anya.jpg')
        ...
        for i in range(result.shape[0]):
            for j in range(result.shape[1]):
                cv2.imwrite(f"D:\Phong\Python\AI\BTL_AI\Image\my_block_{i*n+j}.jpg", result[i,j])
        ...
        for row in range(self.rows):
            for col in range(self.cols):
                ...
                if self.tiles[row][col].val == 0:
                    ...
                    image = pygame.image.load("D:\Phong\Python\AI\BTL_AI\Image\my_block_{}.jpg".format(self.tiles[row][col].val))
                    self.tiles[row][col].draw_tile(window,self.tile_width, self.tile_height, image) 
        
        # ve anh mau
        image = pygame.image.load("D:\Phong\Python\AI\BTL_AI\Image\Anya_resize.jpg")
