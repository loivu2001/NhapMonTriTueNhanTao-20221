...
def main():
  ...
  #  args = parse_cli()
    ...
    astar1_img = pygame.image.load('D:\Phong\Python\AI\BTL_AI\Image\heuristic1.jpg').convert_alpha()
    bfs_img = pygame.image.load('D:\Phong\Python\AI\BTL_AI\Image\ebfs_img.jpeg').convert_alpha()
    astar2_img = pygame.image.load('D:\Phong\Python\AI\BTL_AI\Image\heuristic2.jpg').convert_alpha()
